...
| 1 | Aug 2023 | Initial knee exercise proof-of-concept (PoC). <br/> Video & Image Processing - Assignment 2 [MR-video-processing] (https://github.com/claudiunz/MR-video-processing). |  main.py <- pose_estimation.py |
